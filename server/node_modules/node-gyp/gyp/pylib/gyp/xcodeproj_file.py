...
class XCObject(object):
  ...
  def Copy(self):
    ...
    for key, value in self._properties.iteritems():
      ...
      if isinstance(value, XCObject):
        ...
        raise TypeError((((
            (f'Unexpected type {value.__class__.__name__}' + ' for key ') + key)
    ...
    for property, value in properties.iteritems():
      ...
      if is_list:
        if value.__class__ != list:
          raise TypeError(((f'{property} of {self.__class__.__name__}' +
        ...
        for item in value:
          if not isinstance(item, property_type) and (item.__class__ != unicode
            ...
            # UTF-8-encoded.
            raise TypeError(
                ((((f'item of {property} of {self.__class__.__name__}' +
        ...
        # UTF-8-encoded.
        raise TypeError(
            (((f'{property} of {self.__class__.__name__} must be ' +
  ...
  def AppendProperty(self, key, value):
    ...
    if not isinstance(value, property_type):
      raise TypeError(
          ((((f'item of {key} of {self.__class__.__name__}' + ' must be ') +
             property_type.__name__) + ', not ') + value.__class__.__name__))
